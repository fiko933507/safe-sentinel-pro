...
check(/applicationId\s+['"]com\.fiko93\.safesentinel['"]/.test(gradle), 'Android applicationId beklenen değer değil.');
check(/namespace\s+['"]com\.fiko93\.safesentinel['"]/.test(gradle), 'Android namespace beklenen değer değil.');
check(/versionCode\s+\d+/.test(gradle), 'Android versionCode eksik.');
